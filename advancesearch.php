...
<center>
<table>
<tr><td>কর্মকর্তার নামঃ<font color=red></font></td><td><input type="text" name="tname"></td></tr>
<tr><td>পদবীঃ<font color=red></font></td><td><input type="text" name="tdesig"></td></tr>
<tr><td>তারিখ শুরুঃ<font color=red></font></td><td><input type="date" name="tdate"></td></tr>
<tr><td>তারিখ শেষঃ<font color=red></font></td><td><input type="date" name="t1date"></td></tr>
</table>
...
$query = "SELECT * FROM tinfo WHERE tfsdate BETWEEN '$_POST[tdate]' AND '$_POST[t1date]' AND name LIKE '%$_POST[tname]%' AND designation LIKE '%$_POST[tdesig]%' AND status=1 "; 
...
print "<table width=100%>";
 print "<tr bgcolor=#2bf05e>";  
   ...
   echo "<th>প্রশিক্ষণের বিষয়/ধরণ</th>";

   echo "<th>দেশ</th>";  
   echo "<th>শুরুর তারিখ</th>";
   
    echo "<th>শেষ তারিখ</th>";
